...
namespace meta
{
    ...
    namespace detail
    {
		...
		void foreach(Function function, ctti::meta::list<Ts...>, std::index_sequence<Indices...>)
        {
            (void)function;
		...
		struct std_index_sequence<list<size_t<Index>...>>
        {
			using type = std::index_sequence<Index...>;
        };
		template<>
		struct std_index_sequence<list<>>
		{
    ...
    {
		using index_sequence_t = typename detail::std_index_sequence<ctti::meta::make_index_sequence_from_sequence<Sequence>>::type;
		ctti::meta::detail::foreach(function, ctti::meta::apply_functor<ctti::meta::list<>, Sequence>{}, index_sequence_t{});
    }
}
